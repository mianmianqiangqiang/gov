$(document).ready(function() {
	...
	function Project_Details(PRJNUM) {
		var data =
			'[{"PRJNAME":"尧都区国际博览城建设项目","PRJNUM":1410021605130102.0,"PROVINCEPRJNUM":"","PRJTYPENAME":"公共建筑","BuildCorpName":"尧都区城市投资有限公司                                                                                                                                                                              ","PRJFUNCTIONNAME":"公共建筑","BUILDCORPCODE":"9114010072592573X2  ","ProvinceNum":"山西省","CityNum":"临汾市","CountyNum":"尧都区","PRJPROPERTYNAME":"新建"}]'
	...
	function Engineering_Cost(PRJNUM) {
		var data='[{"PrjCode":null,"PROVINCEPRJNUM":1410021605130102.0,"PrjName":"尧都区国际博览城建设项目","PRJTYPENAME":"公共建筑","Citynum":"临汾市","COUNTYNUM":"尧都区","Address":"众望路与二中路之间                                                                                                                                                                                                                                             ","LocationX":null,"LocationY":null,"PrjApprovalNum":"尧区发改审批发【2015】141号                                                                                                                                                                             ","PrjApprovalLevelname":"区县级","PrjApprovalDepart":null,"PrjApprovalDate":"1900-01-01T00:00:00","BuildCorpName":"尧都区城市投资有限公司                                                                                                                                                                              ","BuildCorpCode":"9114010072592573X2  ","BuildPlanNum":"地字第201500039号                                                                                                                                                                                       ","ProjectPlanNum":"建字第203200023-25号                                                                                                                                                                                                                                                                                        ","INVPROPERTYNAME":null,"PrjTwoDimCode":null,"FundSource":null,"NationalPercentTage":100.0,"AllInvest":69000,"AllArea":256493.78,"AllLength":null,"PRJPROPERTYNAME":"新建","PrjSize":"总建筑面积256493.78平米","IsMajor":"是","PRJFUNCTIONNAME":"公共建筑","BeginDete":"1900-01-01T00:00:00","EndDate":"1900-01-01T00:00:00","CXXMInfo":null,"DataLevel":"B","DataSource":"历史补录"}]'
		///后续操作。。。
		var datainfo = $.parseJSON(data); //  .datainfo;
	...
	function Bidding(PRJNUM) {
		...
		var data='[{"PRJNUM":1410021605130102.0,"TENDERCLASSNAME":"施工","TENDERTYPENAME":"公开招标","TenderCorpName":"山西晋技建筑工程有限公司                                                                                                                                                                                ","TenderResultDate":"2016-07-01T00:00:00","PROVINCETENDERNUM":"","TenderNum":"1410021605130102-BD-001","TenderMoney":69000,"DATALEVEL":"B"}]'
	...
	// 	var data='[{"ID":null,"PRJNUM":1410021605130102.0,"PROVINCEPRJNUM":null,"PRJNAME":"尧都区汾东棚户区改造4、5、6号安置小区","PRJTYPENUM":"01","BUILDCORPNAME":"尧都区城市投资有限公司","Constructoridcard":"140104196304241372","Createdate_Char":"2016-07-15","IDCARDTYPENAME":"身份证","DataSource1":"历史补录","DataLevel1":"B"}]'
	...
	function Contract(PRJNUM) {
		var data='[{"Row_Num":1,"PrjNum":1410021605130102.0,"CONTRACTTYPENAME":"施工总包","RecordNum":"1410021605130102-HZ-001","ContractMoney":69000,"DATALEVEL":"B","PropietorCorpName":"尧都区城市投资有限公司                                                                                                                                                                              ","ContractorCorpName":"山西晋技建筑工程有限公司                                                                                                                                                                                "}]'
		///后续操作。。。
		var datainfo = $.parseJSON(data); //  .datainfo;
		if (datainfo.length > 0) {
			$("#Contract").html("");
	...
	function BuilderLicenceManage(PRJNUM) {
		var data='[{"Row_Num":1,"PRJNUM":1410021605130102.0,"BuilderLicenceNum":"1410021605130102-SX-001","PROVINCEBUILDERLICENCENUM":"","ContractMoney":69000,"Area":256493.78,"ReleaseDate":"2016-11-23T00:00:00","DATALEVEL":"B"}]'
		///后续操作。。。
		var datainfo = $.parseJSON(data); //  .datainfo;
		if (datainfo.length > 0) {
